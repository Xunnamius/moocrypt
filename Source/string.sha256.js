...
(function() {
    ...
    **/
    ...
    SHA256 = {
        ...
        'binb2hex': function(binarray, hexcase)
        {
        ...
        'core': function(m, l)
        {
    		...
    		for (var i = 0, l = m.length; i < l; i += 16)
            {
    			a = HASH[0];
    			b = HASH[1];
    			c = HASH[2];
        ...
        'hash': function(string)
        {
            ...
            return this.binb2hex(this.core(this.str2binb(string.toUTF8(), chrsz), string.length * chrsz), hexcase);
        }
    };
